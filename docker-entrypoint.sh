...
# First-run accounts are the app's own job: an empty instance seeds
# admin/admin123 (override once via GAMMA_ADMIN_USER/GAMMA_ADMIN_PASSWORD)
# at startup and never touches accounts again. Locked out? Use:
